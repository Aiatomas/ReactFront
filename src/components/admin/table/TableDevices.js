...
export const TableDevices = ({name}) => {
                                                ...
                                                <MDBTable hover>
                                                    ...
                                                    <MDBTableBody>
                                                        <tr>
                                                            ...
                                                            <td><Form.Control value={price} className="" type="number" onChange={setPriceF} placeholder="price" /></td>
                                                            <td>
                                                ...
                                                <MDBTableBody>
                                                    {data.rows.map((item) => (
                                                        <tr key={item.id}>
                                                            ...
                                                            <td>{item.price}</td>
                                                            {/*<td>*/}
                                                            {/*    <button toclick={item.id} className="btnm bg-info">edit</button>*/}
                                                            {/*</td>*/}
                                                            <td>
                                                                <button toclick={item.id} onClick={deleteThisRowF} className="btnm bg-danger float-end">delete</button>
                                                            </td>
                                                        </tr>
                                                    ))}
                                                </MDBTableBody>
